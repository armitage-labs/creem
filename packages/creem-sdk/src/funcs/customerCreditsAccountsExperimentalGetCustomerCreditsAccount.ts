 ...
 */
export function customerCreditsAccountsExperimentalGetCustomerCreditsAccount(
  client: CreemCore,
  id: string,
...
> {
  const input: operations.GetCustomerCreditsAccountRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetCustomerCreditsAccountRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/customer-credits/accounts/{id}")(pathParams);
