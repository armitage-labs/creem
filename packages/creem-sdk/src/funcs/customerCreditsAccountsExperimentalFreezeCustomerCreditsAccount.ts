 ...
 */
export function customerCreditsAccountsExperimentalFreezeCustomerCreditsAccount(
  client: CreemCore,
  id: string,
...
> {
  const input: operations.FreezeCustomerCreditsAccountRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.FreezeCustomerCreditsAccountRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/customer-credits/accounts/{id}/freeze")(
    pathParams,
  );
