 ...
 */
export function customersListCustomerSubscriptions(
  client: CreemCore,
  id: string,
...
> {
  const input: operations.ListCustomerSubscriptionsRequest = {
    id: id,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListCustomerSubscriptionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/customers/{id}/subscriptions")(pathParams);
