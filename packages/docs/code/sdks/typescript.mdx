...
- **[MCP server](/ai/for-agents/mcp-server)** bundled in this package — 77 tools for Claude, Cursor and other MCP clients
...
- [Creem SDK on GitHub](https://github.com/armitage-labs/creem/tree/main/packages/sdk)
...
> For feedback or issues, open a PR or issue in the [Creem monorepo](https://github.com/armitage-labs/creem/issues).
