...
<Tip>
  That's it! Claude Code now has complete knowledge of the Creem API and will generate
  production-ready integration code when you ask about payments, subscriptions, webhooks, or
  licenses.
</Tip>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="https://github.com/armitage-labs/creem/tree/main/packages/docs/skills/creem-api"
  >
    Copy the folder into your project: `npx degit armitage-labs/creem/packages/docs/skills/creem-api/skills/creem-api
    creem-skill`
  </Card>
</CardGroup>
...
<Accordion title="Webhook Events (13 types)">
...
| `subscription.past_due`         | Payment failed, retries pending       |
| `subscription.unpaid`           | Payment collection failed             |
...
<Note>**Recommended Method**: Use the plugin marketplace for the easiest setup experience.</Note>
...
// Your backend proxies these calls to Creem. The merchant API key
// never ships inside the desktop binary.
