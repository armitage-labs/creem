...
# Migration.
#
# Do not "fix" this by adding it to docs.json - that is a deliberate exception
# to the repo rule in packages/docs/CLAUDE.md. Keep the page self-contained so
# an agent that lands here needs no other page.
---
