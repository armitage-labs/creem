...
<Frame>
  <img
    src="/images/convex/billing-history-light.webp"
    alt="A billing history table with Date, Description, Type, Status, and Amount columns listing five paid transactions, above a pager running from page 1 to page 22"
    className="block dark:hidden"
  />
  <img
    src="/images/convex/billing-history-dark.webp"
    alt="A billing history table with Date, Description, Type, Status, and Amount columns listing five paid transactions, above a pager running from page 1 to page 22"
...
<Frame>
  <img
    src="/images/convex/payment-recovery-light.webp"
    alt="A yellow past-due banner above a red payment-failed banner, followed by an Update payment method button"
    className="block dark:hidden"
  />
  <img
    src="/images/convex/payment-recovery-dark.webp"
    alt="A yellow past-due banner above a red payment-failed banner, followed by an Update payment method button"
    className="hidden dark:block"
  />
</Frame>
