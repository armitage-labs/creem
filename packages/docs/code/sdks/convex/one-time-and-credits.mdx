...
<Frame>
  <img
    src="/images/convex/credits-balance-light.webp"
    alt="A Credit Balance card showing 490 credits with a refresh icon and a Generate image button costing 10 credits"
    className="block dark:hidden"
  />
  <img
    src="/images/convex/credits-balance-dark.webp"
    alt="A Credit Balance card showing 490 credits with a refresh icon and a Generate image button costing 10 credits"
...
<Frame>
  <img
    src="/images/convex/product-upgrade-path-light.webp"
    alt="Two product cards side by side: Basic at $400 marked Owned with no buy button, and Premium at $700 offering an Upgrade button"
    className="block dark:hidden"
  />
  <img
    src="/images/convex/product-upgrade-path-dark.webp"
    alt="Two product cards side by side: Basic at $400 marked Owned with no buy button, and Premium at $700 offering an Upgrade button"
    className="hidden dark:block"
  />
</Frame>
