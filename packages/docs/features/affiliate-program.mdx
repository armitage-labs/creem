...
<CardGroup cols={2}>
  ...
  <Card
    title="Referly Integration"
    icon="plug"
    href="/integrations/referly"
  >
    Alternative: Use Referly for external affiliate tracking, coupon codes and payouts
  </Card>
</CardGroup>
