...
| `proration-charge`             | Access changes now; prorated difference is charged on the next invoice.     | Plan changes now; unused time becomes subscription credit for a future invoice. |
...
- **proration-charge**: Customer pays the ~\$10 prorated difference on the next invoice.
