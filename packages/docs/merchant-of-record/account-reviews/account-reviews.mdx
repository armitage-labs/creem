...
- **Rejected** — We aren't able to onboard the account as it stands. There's no **Request re-review** button for this outcome. See
   [If your account was rejected](/merchant-of-record/account-reviews/rejected-accounts).
