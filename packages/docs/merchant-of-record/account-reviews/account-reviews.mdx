...
Account reviews are typically completed within **24-48 hours**. During peak periods, it may take up to 72 hours. You'll receive an email from **compliance@creem.io** once the review is complete or if changes are requested.

### What happens after the review

- **Approved:** Your store is live and you can start accepting payments.
- **Changes requested:** You'll receive an email from compliance@creem.io with the specific issues to fix. Reply directly to that email once you've made the changes — do not reply in support chat. See the [Re-Review Guide](/merchant-of-record/account-reviews/re-review-guide) for step-by-step instructions.

<Warning>
  Re-reviews are triggered by replying to the compliance email from compliance@creem.io — not through support chat. Replies sent in the wrong place will not queue a re-review.
</Warning>

### Finding your Store ID

Your Store ID (e.g. `sto_abc123`) is required whenever you contact the compliance team or Creem support. Go to **Settings** in your dashboard — your Store ID is displayed at the top of the page.

<Tip>
  Save your Store ID somewhere handy before you need it. Merchants who include their Store ID in every support or compliance message get faster responses.
</Tip>
