...
Account reviews are typically completed within **24-48 hours**. During peak periods, it may take up to 72 hours. You'll receive an email notification once the review is complete, if changes are requested, or if the account is rejected.
...
- **Rejected** — We aren't able to support this business on Creem. This is a final decision for this store, and there's no **Request re-review** button for it. See [If your account was rejected](/merchant-of-record/account-reviews/rejected-accounts).
...
<Accordion title="Full list of prohibited products">
  ...
  - Counterfeit or unauthorized products and content, including PLR or MRR products, for which you do not hold the required licenses, intellectual property rights, or resale rights
  - Face-swap, deepfake, and face-manipulation tools of any kind
  - Sexually-oriented or pornographic content and AI companion or relationship chatbots of any kind, including AI-generated content, NSFW chatbots, and romantic AI characters
  - Telecommunications and connectivity products such as eSIMs, SIM cards, mobile data plans, calling plans, VoIP services, wireless carriers, or internet service providers
  ...
  - In-game items, currencies, accounts, boosting services, and virtual goods tied to third-party games, including automation or account-management software that violates the game publisher's Terms of Service
  - Any other products that our providers and partners deem too risky
  - Products that operate marketplaces or facilitate third-party merchant-funded customer payouts, including cashback, rebates, referral payouts, rewards, or similar payments from merchants to customers
</Accordion>
