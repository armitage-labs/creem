...
<Accordion title="Can I keep building while I wait?">
    Please finalise the requested adjustments before asking for a re-review. But you can carry on testing your CREEM integration while you wait for the review — you just can't take live payments until the account is approved.
  </Accordion>
<Accordion title="I wasn't told what to change">
    The specific feedback is in the email we sent and in [your dashboard](https://www.creem.io/dashboard/balances/accounts). If it isn't clear, work through all of the items in Step 1 — most accounts that come back have hit more than one, and fixing them all before you resubmit is faster than resubmitting twice.

    If your status is **Rejected** rather than changes requested, this guide doesn't apply — see [If your account was rejected](/merchant-of-record/account-reviews/rejected-accounts).
  </Accordion>
</AccordionGroup>
