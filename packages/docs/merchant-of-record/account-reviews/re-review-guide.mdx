...
<Accordion title="I wasn't told what to change">
   Contact support with your Store ID, your website address, and what you've already changed since the review. If your account was rejected rather than sent back for changes, see [If your account was rejected](/merchant-of-record/account-reviews/rejected-accounts) — the route is different.
  </Accordion>
</AccordionGroup>
