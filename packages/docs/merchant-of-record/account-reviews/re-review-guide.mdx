...
<AccordionGroup>
  <Accordion title="I fixed everything but got another change request">
...
<Accordion title="Can I keep building while I wait?">
    Yes. Test Mode keeps working throughout a review and a re-review. You can carry on building and testing your integration — you just can't take live payments until the account is approved.
  </Accordion>
<Accordion title="I wasn't told what to change">
    The specific feedback is in the email we sent when the review completed. If it isn't clear, work through all of the items in Step 1 — most accounts that come back have hit more than one, and fixing them all before you resubmit is faster than resubmitting twice.

    If your status is **Rejected** rather than changes requested, this guide doesn't apply — see [If your account was rejected](/merchant-of-record/account-reviews/rejected-accounts). You can always see the comments on why your account was rejected or what changes were requested here: (https://www.creem.io/dashboard/balances/accounts).
  </Accordion>
</AccordionGroup>
