...
If a payout fails, the funds are returned to your Creem balance within 3 business days and will be available for the next payout window (1st or 15th of the month). You do not lose the money — it stays in your balance.

### Common causes and fixes

| Cause | How to identify | Fix |
| --- | --- | --- |
| **Bank account details incorrect** | Payout shows "failed" in Balance → Payout Activity | Update your bank details in **Balance → Payout Account** and re-initiate the withdrawal |
| **Identity mismatch** | The name on the bank account doesn't match your Creem KYC/KYB details | Contact [Creem support](https://creem.io/contact) with your Store ID — the team can investigate the mismatch |
| **Banking partner processing issue** | Payout appears processing for more than 5 business days | Contact [Creem support](https://creem.io/contact) with your Store ID and the payout date |
| **International transfer limits** | Payout above limit for your country | Check the [transfer limits section](#transfer-limits) and consider splitting into smaller withdrawals |
| **Payout day fell on weekend/holiday** | Expected 1-2 day delay | Wait for the next business day — no action needed |

### If your funds are missing after a failed payout

If more than 5 business days have passed since a payout failure and the funds have not returned to your balance, contact [Creem support](https://creem.io/contact) immediately. Include:

- Your **Store ID** (found in Settings)
- The **exact date** the withdrawal was initiated
- The **amount** of the failed payout
- Your **bank account details** (last 4 digits is enough)

<Warning>
  Payout disputes are time-sensitive. If you have missing funds, reach out as soon as possible — the earlier we can investigate with our banking partners, the faster the resolution.
</Warning>
