...
- A [Creem account](https://creem.io/) with at least one product and an API key
...
Install Creem from the [Framer Marketplace](https://www.framer.com/community/marketplace/plugins/creem/), or find it directly inside Framer:
...
<Steps>
  ...
  <Step title="Install Creem">
    ...
    <Frame caption="Select the Creem plugin from the plugins list">
      <img
        style={{ borderRadius: '0.5rem' }}
        src="/images/framer/select-creem-plugin.png"
        alt="Select the Creem plugin in the modal"
      />
    </Frame>
  </Step>
</Steps>
...
The first time you open the plugin, create a **store** from your Creem API keys. A store holds a **Live** key, a **Test** key, or both, so you can browse either catalog and switch between them at any time.

<Frame caption="Name your store and paste a Live and/or Test API key">
  <img
    style={{ borderRadius: "0.5rem" }}
...
<Frame caption="The store switcher: switch stores, toggle Live/Test, add or manage stores">
  <img
    style={{ borderRadius: "0.5rem" }}
...
After connecting, choose what to add to your canvas: a **Checkout Button** for a single product, or a **Pricing Table** to compare several.

<Frame caption="Pick a checkout button or a pricing table">
  <img
    style={{ borderRadius: "0.5rem" }}
    src="/images/framer/choose-component.png"
    alt="Choose a component: Checkout Button or Pricing Table"
  />
</Frame>

## Insert a checkout button

A checkout button sends visitors to checkout for a single product.
...
A pricing table compares several products side by side. You can mix one-time and subscription products in the same table.
...
<Steps>
  ...
  <Step title="Insert Pricing Table">
    ...
    <Frame caption="The inserted pricing table on the Framer canvas">
      <img
        style={{ borderRadius: '0.5rem' }}
        src="/images/framer/pricing-table-on-canvas.png"
        alt="Pricing table rendered on the Framer canvas"
      />
    </Frame>
...
The button is one group of controls. The plugin fills in the product and a starting style at insert time; everything below is yours to brand.
...
| **Type**                                                | Whether checkout opens as an Embed (a modal over the current page) or in a New Tab. Embed keeps buyers on your site; New Tab is the safer choice when the button sits inside a restrictive embed or you want a full checkout window.                                                        |
...
The pricing table splits its controls into groups, one per area of the table, matching the rows in the panel. Work top down: get the **Table** shape right first, then style the **Card**, then set apart the **Featured Tier** and its buttons.
...
<AccordionGroup>
  ...
  <Accordion title="Card">
    ...
    style here; the featured card inherits it and overrides only its highlighted parts.
  </Accordion>
  <Accordion title="Featured Tier">
    The extra styling for whichever tier you marked **Featured**: its button colors and a heavier
    border. Use it to make your recommended plan stand out from the standard cards without restyling
    every card.
  </Accordion>
