...
After connecting, choose what to add to your canvas. Pick a **Checkout Button** for a single product, or a **Pricing Table** to compare several.
...
The button is one group of controls. The plugin fills in the product and a starting style at insert time, and everything below is yours to brand.
