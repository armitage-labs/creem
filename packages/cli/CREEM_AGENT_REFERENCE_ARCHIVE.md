# Archived Creem agent reference

> [!WARNING]
> This is an unmaintained snapshot preserved while a separately distributed
> Creem CLI/API skill is designed. It is not active repository instruction and
> must not be treated as current product, API, or CLI documentation.
>
> Canonical documentation: <https://docs.creem.io>
> Current CLI behavior: `creem --help` and [`README.md`](./README.md)

The content below is preserved verbatim from `packages/cli/AGENTS.md` at
commit `ddf95e6e9fdd5bc69a3d5391dfa9d5d93f6b4ac1` so it can be audited and
reworked in a future distribution task.
---
name: creem
version: 0.1.0
