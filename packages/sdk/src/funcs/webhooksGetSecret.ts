...
export function webhooksGetSecret(
  ...
  Result<
    components.WebhookSecretEntity,
    | CreemError
...
> {
  const input: operations.GetWebhookSecretRequest = {
    id: id,
  };
  ...
  const path = pathToFunc("/v1/webhooks/{id}/secret")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.WebhookSecretEntity$inboundSchema),
