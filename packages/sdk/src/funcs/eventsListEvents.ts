...
export function eventsListEvents(
  ...
  PageIterator<
    Result<
      operations.ListUsageEventsResponse,
      | CreemError
...
> {
  const input: operations.ListUsageEventsRequest = {
    meterId: meterId,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ListUsageEventsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListUsageEventsResponse$inboundSchema, {
      key: "Result",
    }),
