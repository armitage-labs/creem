 ...
 */
export function eventsPreviewEvents(
  client: CreemCore,
  request: components.IngestUsageEventsApiRequestDto,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PreviewUsageEventsApiResponseDto,
...
> {
  ...
  const path = pathToFunc("/v1/events/preview")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PreviewUsageEventsApiResponseDto$inboundSchema),
