 ...
 */
export function affiliatesListInvites(
  client: CreemCore,
  ...
  PageIterator<
    Result<
      operations.ListAffiliateInvitesResponse,
      | CreemError
...
> {
  const input: operations.ListAffiliateInvitesRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListAffiliateInvitesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/affiliates/invites")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAffiliateInvitesResponse$inboundSchema, {
      key: "Result",
    }),
