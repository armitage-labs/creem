 ...
 */
export function metersUpdateMeter(
  client: CreemCore,
  id: string,
...
> {
  const input: operations.UpdateMeterRequest = {
    id: id,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.UpdateMeterRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateMeterApiRequestDto, {
    explode: true,
  });
  ...
  >(
    ...
    M.jsonErr(
      [409, 422],
      errors.UsageMeteringErrorApiResponseDto$inboundSchema,
    ),
