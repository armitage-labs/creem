...
> {
  const input: operations.ListSplitsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ListSplitsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSplitsResponse$inboundSchema, { key: "Result" }),
