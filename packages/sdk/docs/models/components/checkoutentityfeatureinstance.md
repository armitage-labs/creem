...
```typescript
import { CheckoutEntityFeatureInstance } from "creem/models/components";

let value: CheckoutEntityFeatureInstance = {
  id: "<id>",
  mode: "test",
...
| `status`                                                                                         | [components.CheckoutEntityFeatureStatus](../../models/components/checkoutentityfeaturestatus.md) | :heavy_check_mark:                                                                               | The status of the license instance.                                                              | active                                                                                           |
