...
```typescript
import { CheckoutEntityInstance } from "creem/models/components";

let value: CheckoutEntityInstance = {
  id: "<id>",
  mode: "test",
...
| `status`                                                                                      | [components.CheckoutEntityStatus](../../models/components/checkoutentitystatus.md)            | :heavy_check_mark:                                                                            | The status of the license instance.                                                           | active                                                                                        |
