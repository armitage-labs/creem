...
<Note>
  With Better Auth, subscription data is automatically persisted to your database and synced via webhooks.
</Note>
...
<Tip>
  Always pass a `referenceId` or include user identification in the `metadata` when creating checkouts. This allows you to map Creem customers to your internal user IDs.
</Tip>
