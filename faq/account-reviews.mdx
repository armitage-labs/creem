...
<Tip>
Below you can find a TLDR checklist to ensure your account review is successful.
</Tip>
...
| Compliance with acceptable product list | Your product complies with our acceptable product list |
