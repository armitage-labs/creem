...
<Warning>
  Resources highlighted here are maintained by third-party developers. We do our best to showcase helpful projects, but Creem is <strong>not liable for any code or dependencies you install from third-party sources</strong>. Always review the code before integrating. 
</Warning>
...
<Note>
  Looking for official SDKs? Check out our <a href="/code/sdks/typescript">TypeScript SDK</a> and <a href="/code/sdks/nextjs">Next.js adapter</a>.
</Note>
...
<Tip>
  Our official <a href="/code/sdks/templates">Next.js template</a> includes Prisma, Better Auth, and Shadcn UI out of the box.
</Tip>
...
Need help? Reach us at support@creem.io or join the [Discord community](https://discord.gg/q3GKZs92Av).
